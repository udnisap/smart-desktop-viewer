/*
 PlayCanvas Engine v0.186.3 revision 023a7c8
 http://playcanvas.com
...
b,c,e,f,h,g,d,l,n,k,q,r,p,t,x,y,w,v,z,u,A,B,C,E,L,P,M,H,D;D=this.data;a=D[0];b=D[1];c=D[2];e=D[3];f=D[4];h=D[5];g=D[6];d=D[7];l=D[8];n=D[9];k=D[10];q=D[11];r=D[12];p=D[13];t=D[14];x=D[15];y=a*h-b*f;w=a*g-c*f;v=a*d-e*f;z=b*g-c*h;u=b*d-e*h;A=c*d-e*g;B=l*p-n*r;C=l*t-k*r;E=l*x-q*r;L=n*t-k*p;P=n*x-q*p;M=k*x-q*t;H=1/(y*M-w*P+v*L+z*E-u*C+A*B);D[0]=(h*M-g*P+d*L)*H;D[1]=(-b*M+c*P-e*L)*H;D[2]=(p*A-t*u+x*z)*H;D[3]=(-n*A+k*u-q*z)*H;D[4]=(-f*M+g*E-d*C)*H;D[5]=(a*M-c*E+e*C)*H;D[6]=(-r*A+t*v-x*w)*H;D[7]=(l*A-k*
v+q*w)*H;D[8]=(f*P-h*E+d*B)*H;D[9]=(-a*P+b*E-e*B)*H;D[10]=(r*u-p*v+x*y)*H;D[11]=(-l*u+n*v-q*y)*H;D[12]=(-f*L+h*C-g*B)*H;D[13]=(a*L-b*C+c*B)*H;D[14]=(-r*z+p*w-t*y)*H;D[15]=(l*z-n*w+k*y)*H;return this},setIdentity:function(){var a=this.data;a[0]=1;a[1]=0;a[2]=0;a[3]=0;a[4]=0;a[5]=1;a[6]=0;a[7]=0;a[8]=0;a[9]=0;a[10]=1;a[11]=0;a[12]=0;a[13]=0;a[14]=0;a[15]=1;return this},setTRS:function(a,b,c){var e,f,h,g,d,l,n,k,q,r,p,t,x;e=a.x;f=a.y;a=a.z;h=b.x;g=b.y;d=b.z;l=b.w;b=c.x;n=c.y;c=c.z;k=h+h;q=g+g;r=d+d;
...
b[2],z=b[6],u=b[10],A=Math.abs(d),B=Math.abs(p),C=Math.abs(t),E=Math.abs(x),L=Math.abs(y),P=Math.abs(w),M=Math.abs(v),H=Math.abs(z),D=Math.abs(u);c.set(b[12]+d*f[0]+p*f[1]+t*f[2],b[13]+x*f[0]+y*f[1]+w*f[2],b[14]+v*f[0]+z*f[1]+u*f[2]);e.set(A*h[0]+B*h[1]+C*h[2],E*h[0]+L*h[1]+P*h[2],M*h[0]+H*h[1]+D*h[2])},compute:function(b){for(var c=d.set(b[0],b[1],b[2]),e=a.set(b[0],b[1],b[2]),f=b.length/3,h=1;h<f;h++){var q=b[3*h+0],r=b[3*h+1],p=b[3*h+2];q<c.x&&(c.x=q);r<c.y&&(c.y=r);p<c.z&&(c.z=p);q>e.x&&(e.x=
...
this.extTextureHalfFloatLinear=g.getExtension("OES_texture_half_float_linear");this.extTextureHalfFloat&&(this.extTextureHalfFloatRenderable=c(g,this.extTextureHalfFloat,this.extTextureHalfFloat.HALF_FLOAT_OES));this.extUintElement=g.getExtension("OES_element_index_uint");this.maxVertexTextures=g.getParameter(g.MAX_VERTEX_TEXTURE_IMAGE_UNITS);this.supportsBoneTextures=this.extTextureFloat&&0<this.maxVertexTextures;this.maxShadowType=pc.SHADOW_VSM8;this.extTextureFloatRenderable?this.maxShadowType=
pc.SHADOW_VSM32:this.extTextureHalfFloatRenderable&&(this.maxShadowType=pc.SHADOW_VSM16);this.extTextureLod=g.getExtension("EXT_shader_texture_lod");this.fragmentUniformsCount=g.getParameter(g.MAX_FRAGMENT_UNIFORM_VECTORS);this.samplerCount=g.getParameter(g.MAX_TEXTURE_IMAGE_UNITS);this.useTexCubeLod=this.extTextureLod&&16>this.samplerCount;this.extDepthTexture=null;(this.extStandardDerivatives=g.getExtension("OES_standard_derivatives"))&&g.hint(this.extStandardDerivatives.FRAGMENT_SHADER_DERIVATIVE_HINT_OES,
g.NICEST);this.extTextureFilterAnisotropic=g.getExtension("EXT_texture_filter_anisotropic");this.extTextureFilterAnisotropic||(this.extTextureFilterAnisotropic=g.getExtension("WEBKIT_EXT_texture_filter_anisotropic"));this.extCompressedTextureS3TC=g.getExtension("WEBGL_compressed_texture_s3tc");this.extCompressedTextureS3TC||(this.extCompressedTextureS3TC=g.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc"));this.extCompressedTextureS3TC&&b()&&(this.extCompressedTextureS3TC=!1);if(this.extCompressedTextureS3TC)for(k=
g.getParameter(g.COMPRESSED_TEXTURE_FORMATS),d=0;d<k.length;d++);this.extInstancing=g.getExtension("ANGLE_instanced_arrays");this.extCompressedTextureETC1=g.getExtension("WEBGL_compressed_texture_etc1");this.extCompressedTexturePVRTC=g.getExtension("WEBGL_compressed_texture_pvrtc")||g.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");this.maxDrawBuffers=(this.extDrawBuffers=g.getExtension("EXT_draw_buffers"))?g.getParameter(this.extDrawBuffers.MAX_DRAW_BUFFERS_EXT):1;this.maxColorAttachments=
this.extDrawBuffers?g.getParameter(this.extDrawBuffers.MAX_COLOR_ATTACHMENTS_EXT):1;this.renderTarget=null;this.scope=new pc.ScopeSpace("Device");this.commitFunction={};this.commitFunction[pc.UNIFORMTYPE_BOOL]=function(a,b){g.uniform1i(a,b)};this.commitFunction[pc.UNIFORMTYPE_INT]=function(a,b){g.uniform1i(a,b)};this.commitFunction[pc.UNIFORMTYPE_FLOAT]=function(a,b){"number"==typeof b?g.uniform1f(a,b):g.uniform1fv(a,b)};this.commitFunction[pc.UNIFORMTYPE_VEC2]=function(a,b){g.uniform2fv(a,b)};this.commitFunction[pc.UNIFORMTYPE_VEC3]=
function(a,b){g.uniform3fv(a,b)};this.commitFunction[pc.UNIFORMTYPE_VEC4]=function(a,b){g.uniform4fv(a,b)};this.commitFunction[pc.UNIFORMTYPE_IVEC2]=function(a,b){g.uniform2iv(a,b)};this.commitFunction[pc.UNIFORMTYPE_BVEC2]=function(a,b){g.uniform2iv(a,b)};this.commitFunction[pc.UNIFORMTYPE_IVEC3]=function(a,b){g.uniform3iv(a,b)};this.commitFunction[pc.UNIFORMTYPE_BVEC3]=function(a,b){g.uniform3iv(a,b)};this.commitFunction[pc.UNIFORMTYPE_IVEC4]=function(a,b){g.uniform4iv(a,b)};this.commitFunction[pc.UNIFORMTYPE_BVEC4]=
function(a,b){g.uniform4iv(a,b)};this.commitFunction[pc.UNIFORMTYPE_MAT2]=function(a,b){g.uniformMatrix2fv(a,!1,b)};this.commitFunction[pc.UNIFORMTYPE_MAT3]=function(a,b){g.uniformMatrix3fv(a,!1,b)};this.commitFunction[pc.UNIFORMTYPE_MAT4]=function(a,b){g.uniformMatrix4fv(a,!1,b)};this.setBlending(!1);this.setBlendFunction(pc.BLENDMODE_ONE,pc.BLENDMODE_ZERO);this.setBlendEquation(pc.BLENDEQUATION_ADD);this.setColorWrite(!0,!0,!0,!0);this.setCullMode(pc.CULLFACE_BACK);this.setDepthTest(!0);this.setDepthWrite(!0);
this.setClearDepth(1);this.setClearColor(0,0,0,0);g.enable(g.SCISSOR_TEST);this.programLib=new pc.ProgramLibrary(this);for(var m in pc.programlib)this.programLib.register(m,pc.programlib[m]);m=g.getParameter(g.MAX_VERTEX_UNIFORM_VECTORS);this.boneLimit=Math.floor((m-16-8-1-16)/4);this.boneLimit=Math.min(this.boneLimit,128);"Mali-450 MP"===this.unmaskedRenderer?this.boneLimit=34:"Apple A8 GPU"===this.unmaskedRenderer&&(this.forceCpuParticles=!0);pc.events.attach(this);this.boundBuffer=null;this.instancedAttribs=
{};this.activeTexture=0;this.textureUnits=[];this.attributesInvalidated=!0;this.enabledAttributes={};this._shaderSwitchesPerFrame=this._drawCallsPerFrame=0;this._primsPerFrame=[];for(d=pc.PRIMITIVE_POINTS;d<=pc.PRIMITIVE_TRIFAN;d++)this._primsPerFrame[d]=0;this._renderTargetCreationTime=0;this._vram={tex:0,vb:0,ib:0};this._shaderStats={vsCompiled:0,fsCompiled:0,linked:0,materialShaders:0,compileTime:0};m=g.createBuffer();d=new ArrayBuffer(16);g.bindBuffer(g.ARRAY_BUFFER,m);g.bufferData(g.ARRAY_BUFFER,
d,g.STATIC_DRAW);g.getError();g.vertexAttribPointer(0,4,g.UNSIGNED_BYTE,!1,4,0);this.supportsUnsignedByte=0===g.getError();g.deleteBuffer(m)}).call(this)};l.prototype={updateClientRect:function(){this.clientRect=this.canvas.getBoundingClientRect()},setViewport:function(a,b,c,e){this.gl.viewport(a,b,c,e)},setScissor:function(a,b,c,e){this.gl.scissor(a,b,c,e)},getProgramLibrary:function(){return this.programLib},setProgramLibrary:function(a){this.programLib=a},updateBegin:function(){var a=this.gl;this.indexBuffer=
this.boundBuffer=null;var b=this.renderTarget;if(b)if(b._glFrameBuffer)a.bindFramebuffer(a.FRAMEBUFFER,b._glFrameBuffer);else{b._glFrameBuffer=a.createFramebuffer();a.bindFramebuffer(a.FRAMEBUFFER,b._glFrameBuffer);var c=b._colorBuffer;c._glTextureId||(c._width=Math.min(c.width,this.maxRenderBufferSize),c._height=Math.min(c.height,this.maxRenderBufferSize),this.setTexture(c,0));a.framebufferTexture2D(a.FRAMEBUFFER,a.COLOR_ATTACHMENT0,c._cubemap?a.TEXTURE_CUBE_MAP_POSITIVE_X+b._face:a.TEXTURE_2D,c._glTextureId,
...
break;case a.FRAMEBUFFER_INCOMPLETE_DIMENSIONS:console.error("ERROR: FRAMEBUFFER_INCOMPLETE_DIMENSIONS");break;case a.FRAMEBUFFER_UNSUPPORTED:console.error("ERROR: FRAMEBUFFER_UNSUPPORTED")}}else a.bindFramebuffer(a.FRAMEBUFFER,null);for(a=0;16>a;a++)this.textureUnits[a]=null},updateEnd:function(){var a=this.gl,b=this.renderTarget;b&&(a.bindFramebuffer(a.FRAMEBUFFER,null),b=b._colorBuffer,b._glTextureId&&b.autoMipmap&&pc.math.powerOfTwo(b._width)&&pc.math.powerOfTwo(b._height)&&(a.bindTexture(b._glTarget,
b._glTextureId),a.generateMipmap(b._glTarget)))},initializeTexture:function(a){var b=this.gl,c;a._glTextureId=b.createTexture();a._glTarget=a._cubemap?b.TEXTURE_CUBE_MAP:b.TEXTURE_2D;switch(a._format){case pc.PIXELFORMAT_A8:a._glFormat=b.ALPHA;a._glInternalFormat=b.ALPHA;a._glPixelType=b.UNSIGNED_BYTE;break;case pc.PIXELFORMAT_L8:a._glFormat=b.LUMINANCE;a._glInternalFormat=b.LUMINANCE;a._glPixelType=b.UNSIGNED_BYTE;break;case pc.PIXELFORMAT_L8_A8:a._glFormat=b.LUMINANCE_ALPHA;a._glInternalFormat=
...
b.UNSIGNED_BYTE;break;case pc.PIXELFORMAT_R8_G8_B8_A8:a._glFormat=b.RGBA;a._glInternalFormat=b.RGBA;a._glPixelType=b.UNSIGNED_BYTE;break;case pc.PIXELFORMAT_DXT1:c=this.extCompressedTextureS3TC;a._glFormat=b.RGB;a._glInternalFormat=c.COMPRESSED_RGB_S3TC_DXT1_EXT;break;case pc.PIXELFORMAT_DXT3:c=this.extCompressedTextureS3TC;a._glFormat=b.RGBA;a._glInternalFormat=c.COMPRESSED_RGBA_S3TC_DXT3_EXT;break;case pc.PIXELFORMAT_DXT5:c=this.extCompressedTextureS3TC;a._glFormat=b.RGBA;a._glInternalFormat=c.COMPRESSED_RGBA_S3TC_DXT5_EXT;
break;case pc.PIXELFORMAT_ETC1:c=this.extCompressedTextureETC1;a._glFormat=b.RGB;a._glInternalFormat=c.COMPRESSED_RGB_ETC1_WEBGL;break;case pc.PIXELFORMAT_PVRTC_2BPP_RGB_1:c=this.extCompressedTexturePVRTC;a._glFormat=b.RGB;a._glInternalFormat=c.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;break;case pc.PIXELFORMAT_PVRTC_2BPP_RGBA_1:c=this.extCompressedTexturePVRTC;a._glFormat=b.RGBA;a._glInternalFormat=c.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG;break;case pc.PIXELFORMAT_PVRTC_4BPP_RGB_1:c=this.extCompressedTexturePVRTC;
a._glFormat=b.RGB;a._glInternalFormat=c.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;break;case pc.PIXELFORMAT_PVRTC_4BPP_RGBA_1:c=this.extCompressedTexturePVRTC;a._glFormat=b.RGBA;a._glInternalFormat=c.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;break;case pc.PIXELFORMAT_RGB16F:c=this.extTextureHalfFloat;a._glFormat=b.RGB;a._glInternalFormat=b.RGB;a._glPixelType=c.HALF_FLOAT_OES;break;case pc.PIXELFORMAT_RGBA16F:c=this.extTextureHalfFloat;a._glFormat=b.RGBA;a._glInternalFormat=b.RGBA;a._glPixelType=c.HALF_FLOAT_OES;break;
case pc.PIXELFORMAT_RGB32F:a._glFormat=b.RGB;a._glInternalFormat=b.RGB;a._glPixelType=b.FLOAT;break;case pc.PIXELFORMAT_RGBA32F:a._glFormat=b.RGBA,a._glInternalFormat=b.RGBA,a._glPixelType=b.FLOAT}},uploadTexture:function(a){for(var b=this.gl,c=0,e,f;a._levels[c]||0===c;){e=a._levels[c];1!=c||a._compressed||b.generateMipmap(a._glTarget);if(a._cubemap){var d;b.pixelStorei(b.UNPACK_FLIP_Y_WEBGL,!1);b.pixelStorei(b.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1);if(e[0]instanceof HTMLCanvasElement||e[0]instanceof
HTMLImageElement||e[0]instanceof HTMLVideoElement)for(d=0;6>d;d++)a._levelsUpdated[0][d]&&(f=e[d],f instanceof HTMLImageElement&&(f.width>this.maxCubeMapSize||f.height>this.maxCubeMapSize)&&(f=g(f,this.maxCubeMapSize),0===c&&(a.width=f.width,a.height=f.height)),b.texImage2D(b.TEXTURE_CUBE_MAP_POSITIVE_X+d,c,a._glInternalFormat,a._glFormat,a._glPixelType,f));else for(f=1/Math.pow(2,c),d=0;6>d;d++)if(a._levelsUpdated[0][d]){var h=e[d];a._compressed?b.compressedTexImage2D(b.TEXTURE_CUBE_MAP_POSITIVE_X+
d,c,a._glInternalFormat,Math.max(a._width*f,1),Math.max(a._height*f,1),0,h):b.texImage2D(b.TEXTURE_CUBE_MAP_POSITIVE_X+d,c,a._glInternalFormat,Math.max(a._width*f,1),Math.max(a._height*f,1),0,a._glFormat,a._glPixelType,h)}}else e instanceof HTMLCanvasElement||e instanceof HTMLImageElement||e instanceof HTMLVideoElement?(e instanceof HTMLImageElement&&(e.width>this.maxTextureSize||e.height>this.maxTextureSize)&&(e=g(e,this.maxTextureSize),0===c&&(a.width=e.width,a.height=e.height)),b.pixelStorei(b.UNPACK_FLIP_Y_WEBGL,
!0),b.pixelStorei(b.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),b.texImage2D(b.TEXTURE_2D,c,a._glInternalFormat,a._glFormat,a._glPixelType,e)):(b.pixelStorei(b.UNPACK_FLIP_Y_WEBGL,!1),f=1/Math.pow(2,c),a._compressed?b.compressedTexImage2D(b.TEXTURE_2D,c,a._glInternalFormat,Math.max(a._width*f,1),Math.max(a._height*f,1),0,e):b.texImage2D(b.TEXTURE_2D,c,a._glInternalFormat,Math.max(a._width*f,1),Math.max(a._height*f,1),0,a._glFormat,a._glPixelType,e));c++}if(a._cubemap)for(c=0;6>c;c++)a._levelsUpdated[0][c]=
!1;else a._levelsUpdated[0]=!1;a.autoMipmap&&pc.math.powerOfTwo(a._width)&&pc.math.powerOfTwo(a._height)&&1===a._levels.length&&!a._compressed&&b.generateMipmap(a._glTarget);a._gpuSize&&(this._vram.tex-=a._gpuSize);m||(m={},m[pc.PIXELFORMAT_A8]=1,m[pc.PIXELFORMAT_L8]=1,m[pc.PIXELFORMAT_L8_A8]=1,m[pc.PIXELFORMAT_R5_G6_B5]=2,m[pc.PIXELFORMAT_R5_G5_B5_A1]=2,m[pc.PIXELFORMAT_R4_G4_B4_A4]=2,m[pc.PIXELFORMAT_R8_G8_B8]=4,m[pc.PIXELFORMAT_R8_G8_B8_A8]=4,m[pc.PIXELFORMAT_RGB16F]=8,m[pc.PIXELFORMAT_RGBA16F]=
8,m[pc.PIXELFORMAT_RGB32F]=16,m[pc.PIXELFORMAT_RGBA32F]=16);c=1;if(a.autoMipmap||a._minFilter===b.NEAREST_MIPMAP_NEAREST||a._minFilter===b.NEAREST_MIPMAP_LINEAR||a._minFilter===b.LINEAR_MIPMAP_NEAREST||a._minFilter===b.LINEAR_MIPMAP_LINEAR)c=Math.round(Math.log2(Math.max(a._width,a._height))+1);b=a._width;e=a._height;for(f=d=0;f<c;f++)d=a._compressed?a._format===pc.PIXELFORMAT_ETC1?d+Math.floor((b+3)/4)*Math.floor((e+3)/4)*8:a._format===pc.PIXELFORMAT_PVRTC_2BPP_RGB_1||a._format===pc.PIXELFORMAT_PVRTC_2BPP_RGBA_1?
d+Math.max(b,16)*Math.max(e,8)/4:a._format===pc.PIXELFORMAT_PVRTC_4BPP_RGB_1||a._format===pc.PIXELFORMAT_PVRTC_4BPP_RGBA_1?d+Math.max(b,8)*Math.max(e,8)/2:d+Math.floor((b+4-1)/4)*Math.floor((e+4-1)/4)*(a._format===pc.PIXELFORMAT_DXT1?8:16):d+b*e*m[a._format],b=Math.max(.5*b,1),e=Math.max(.5*e,1);a._cubemap&&(d*=6);a._gpuSize=d;this._vram.tex+=a._gpuSize},setTexture:function(a,b){var c=this.gl;a._glTextureId||this.initializeTexture(a);var e=a._minFilterDirty||a._magFilterDirty||a._addressUDirty||a._addressVDirty||
a._anisotropyDirty;if(this.textureUnits[b]!==a||e)this.activeTexture!==b&&(c.activeTexture(c.TEXTURE0+b),this.activeTexture=b),c.bindTexture(a._glTarget,a._glTextureId),this.textureUnits[b]=a;if(e&&(a._minFilterDirty&&(c.texParameteri(a._glTarget,c.TEXTURE_MIN_FILTER,this.glFilter[a._minFilter]),a._minFilterDirty=!1),a._magFilterDirty&&(c.texParameteri(a._glTarget,c.TEXTURE_MAG_FILTER,this.glFilter[a._magFilter]),a._magFilterDirty=!1),a._addressUDirty&&(c.texParameteri(a._glTarget,c.TEXTURE_WRAP_S,
this.glAddress[a._addressU]),a._addressUDirty=!1),a._addressVDirty&&(c.texParameteri(a._glTarget,c.TEXTURE_WRAP_T,this.glAddress[a._addressV]),a._addressVDirty=!1),a._anisotropyDirty)){if(e=this.extTextureFilterAnisotropic){var f=a.anisotropy,f=Math.min(f,this.maxAnisotropy);c.texParameterf(a._glTarget,e.TEXTURE_MAX_ANISOTROPY_EXT,f)}a._anisotropyDirty=!1}a._needsUpload&&(this.uploadTexture(a),a._needsUpload=!1)},draw:function(a,b){var c=this.gl,e,f,d,g,h,l,m,z;e=this.shader;z=e.samplers;var u=e.uniforms;
1<b&&(this.boundBuffer=null,this.attributesInvalidated=!0);if(this.attributesInvalidated){g=e.attributes;e=0;for(d=g.length;e<d;e++)h=g[e],f=h.scopeId.value,null!==f&&(l=this.vertexBuffers[f.stream],l=l.bufferId,this.boundBuffer!==l&&(c.bindBuffer(c.ARRAY_BUFFER,l),this.boundBuffer=l),h=h.locationId,this.enabledAttributes[h]||(c.enableVertexAttribArray(h),this.enabledAttributes[h]=!0),c.vertexAttribPointer(h,f.numComponents,this.glType[f.dataType],f.normalize,f.stride,f.offset),1===f.stream&&1<b?
this.instancedAttribs[h]||(this.extInstancing.vertexAttribDivisorANGLE(h,1),this.instancedAttribs[h]=!0):this.instancedAttribs[h]&&(this.extInstancing.vertexAttribDivisorANGLE(h,0),this.instancedAttribs[h]=!1));this.attributesInvalidated=!1}var A=0;e=0;for(d=z.length;e<d;e++)if(g=z[e],h=g.scopeId.value)if(h instanceof pc.Texture)l=h,this.setTexture(l,A),g.slot!==A&&(c.uniform1i(g.locationId,A),g.slot=A),A++;else{g.array.length=0;m=h.length;for(f=0;f<m;f++)l=h[f],this.setTexture(l,A),g.array[f]=A,
A++;c.uniform1iv(g.locationId,g.array)}e=0;for(d=u.length;e<d;e++)if(z=u[e],f=z.scopeId,g=z.version,h=f.versionObject.version,g.globalId!==h.globalId||g.revision!==h.revision)if(g.globalId=h.globalId,g.revision=h.revision,null!==f.value)this.commitFunction[z.dataType](z.locationId,f.value);this._drawCallsPerFrame++;this._primsPerFrame[a.type]+=a.count*(1<b?b:1);a.indexed?1<b?(this.extInstancing.drawElementsInstancedANGLE(this.glPrimitive[a.type],a.count,this.indexBuffer.glFormat,2*a.base,b),this.boundBuffer=
null,this.attributesInvalidated=!0):c.drawElements(this.glPrimitive[a.type],a.count,this.indexBuffer.glFormat,a.base*this.indexBuffer.bytesPerIndex):1<b?(this.extInstancing.drawArraysInstancedANGLE(this.glPrimitive[a.type],a.base,a.count,b),this.boundBuffer=null,this.attributesInvalidated=!0):c.drawArrays(this.glPrimitive[a.type],a.base,a.count)},clear:function(a){var b=this.defaultClearOptions;a=a||b;var c=void 0===a.flags?b.flags:a.flags;if(0!==c){var e=this.gl;if(c&pc.CLEARFLAG_COLOR){var f=void 0===
a.color?b.color:a.color;this.setClearColor(f[0],f[1],f[2],f[3])}c&pc.CLEARFLAG_DEPTH&&(this.setClearDepth(void 0===a.depth?b.depth:a.depth),this.depthWrite||e.depthMask(!0));e.clear(this.glClearFlag[c]);c&pc.CLEARFLAG_DEPTH&&(this.depthWrite||e.depthMask(!1))}},readPixels:function(a,b,c,e,f){var d=this.gl;d.readPixels(a,b,c,e,d.RGBA,d.UNSIGNED_BYTE,f)},setClearDepth:function(a){a!==this.clearDepth&&(this.gl.clearDepth(a),this.clearDepth=a)},setClearColor:function(a,b,c,e){if(a!==this.clearRed||b!==
...
this.glBlendFunction[b]),this.blendSrc=a,this.blendDst=b},setBlendEquation:function(a){this.blendEquation!==a&&(this.gl.blendEquation(this.glBlendEquation[a]),this.blendEquation=a)},setCullMode:function(a){if(this.cullMode!==a){var b=this.gl;switch(a){case pc.CULLFACE_NONE:b.disable(b.CULL_FACE);break;case pc.CULLFACE_FRONT:b.enable(b.CULL_FACE);b.cullFace(b.FRONT);break;case pc.CULLFACE_BACK:b.enable(b.CULL_FACE);b.cullFace(b.BACK);break;case pc.CULLFACE_FRONTANDBACK:b.enable(b.CULL_FACE),b.cullFace(b.FRONT_AND_BACK)}this.cullMode=
a}},getCullMode:function(){return this.cullMode},setIndexBuffer:function(a){if(this.indexBuffer!==a){this.indexBuffer=a;var b=this.gl;b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,a?a.bufferId:null)}},setVertexBuffer:function(a,b){if(this.vertexBuffers[b]!==a){this.vertexBuffers[b]=a;for(var c=0,e=a.getFormat().elements,f=e.length;c<f;){var d=e[c++];d.stream=b;d.scopeId.setValue(d)}this.attributesInvalidated=!0}},setShader:function(a){a!==this.shader&&(this.shader=a,a.ready||a.link(),this._shaderSwitchesPerFrame++,
this.gl.useProgram(a.program),this.attributesInvalidated=!0)},getHdrFormat:function(){return this.extTextureHalfFloatRenderable?pc.PIXELFORMAT_RGB16F:this.extTextureFloatRenderable?pc.PIXELFORMAT_RGB32F:pc.PIXELFORMAT_R8_G8_B8_A8},getBoneLimit:function(){return this.boneLimit},setBoneLimit:function(a){this.boneLimit=a},enableValidation:function(a){console.warn("enableValidation: This function is deprecated and will be removed shortly.")},validate:function(){console.warn("validate: This function is deprecated and will be removed shortly.")},
...
"texture2D")),e.replace(/\$UV/g,c).replace(/\$CH/g,a[h])):b[d+"ConstPS"]},_nonPointShadowMapProjection:function(d,a){return!d.getNormalOffsetBias()||d._shadowType>pc.SHADOW_DEPTH?d.getType()===pc.LIGHTTYPE_SPOT?"   getShadowCoordPersp"+a:"   getShadowCoordOrtho"+a:d.getType()==pc.LIGHTTYPE_SPOT?"   getShadowCoordPerspNormalOffset"+a:"   getShadowCoordOrthoNormalOffset"+a},_addVaryingIfNeeded:function(d,a,b){return 0<=d.indexOf(b)?"varying "+a+" "+b+";\n":""},createShaderDefinition:function(d,a){var b,
...
this._skyboxPrefiltered4=this._skyboxPrefiltered8=this._skyboxPrefiltered16=this._skyboxPrefiltered32=this._skyboxPrefiltered64=this._skyboxPrefiltered128=null};d.prototype.update=function(){for(var a=0,b=this._models.length;a<b;a++)this._models[a].getGraph().syncHierarchy()};d.prototype.destroy=function(){var a,b=this.getModels();for(a=0;a<b.length;a++)this.removeModel(b[a]);for(a=0;a<this._lights.length;a++)this.removeLight(this._lights[a]);this.skybox=null};return{Scene:d}}());pc.extend(pc,function(){function d(a,b){return a.zdist&&b.zdist?b.zdist-a.zdist:b.key-a.key}function a(a){var b=Array(a);a=function(a){return b[a]};a.size=0;a.push=function(a){b[this.size]=a;++this.size};a.data=b;return a}function b(a,b,c,e){var f;f=e===pc.SHADOW_VSM32?pc.PIXELFORMAT_RGBA32F:e===pc.SHADOW_VSM16?pc.PIXELFORMAT_RGBA16F:pc.PIXELFORMAT_R8_G8_B8_A8;b=new pc.Texture(a,{format:f,width:b,height:c,autoMipmap:!1});e=e===pc.SHADOW_DEPTH?pc.FILTER_NEAREST:e===pc.SHADOW_VSM32?a.extTextureFloatLinear?
pc.FILTER_LINEAR:pc.FILTER_NEAREST:e===pc.SHADOW_VSM16?a.extTextureHalfFloatLinear?pc.FILTER_LINEAR:pc.FILTER_NEAREST:pc.FILTER_LINEAR;b.minFilter=e;b.magFilter=e;b.addressU=pc.ADDRESS_CLAMP_TO_EDGE;b.addressV=pc.ADDRESS_CLAMP_TO_EDGE;return new pc.RenderTarget(a,b,!0)}function c(a,b){var c=new pc.Texture(a,{format:pc.PIXELFORMAT_R8_G8_B8_A8,width:b,height:b,cubemap:!0,autoMipmap:!1});c.minFilter=pc.FILTER_NEAREST;c.magFilter=pc.FILTER_NEAREST;c.addressU=pc.ADDRESS_CLAMP_TO_EDGE;c.addressV=pc.ADDRESS_CLAMP_TO_EDGE;
for(var e=[],f=0;6>f;f++){var d=new pc.RenderTarget(a,c,{face:f,depth:!0});e.push(d)}return e}function e(a,c,e,f){f||(f=0);f=1E4*f+c;var d=u[e][f];d||(d=b(a,c,c,e?e:pc.SHADOW_DEPTH),u[e][f]=d);return d}function f(a,f){var d;f.getType()===pc.LIGHTTYPE_POINT?(f._shadowType>pc.SHADOW_DEPTH&&(f._shadowType=pc.SHADOW_DEPTH),f._cacheShadowMap?(d=A[f._shadowResolution],d||(d=c(a,f._shadowResolution),A[f._shadowResolution]=d)):d=c(a,f._shadowResolution),f._shadowCamera.setRenderTarget(d[0]),f._shadowCubeMap=
d):(d=f._cacheShadowMap?e(a,f._shadowResolution,f._shadowType):b(a,f._shadowResolution,f._shadowResolution,f._shadowType),f._shadowCamera.setRenderTarget(d))}function h(a){a=this.device=a;this._cullTime=this._forwardTime=this._shadowMapTime=this._shadowMapUpdates=this._materialSwitches=this._camerasRendered=this._removedByInstancing=this._immediateRendered=this._instancedDrawCalls=this._skinDrawCalls=this._forwardDrawCalls=this._shadowDrawCalls=this._depthDrawCalls=0;var b=a.getProgramLibrary();this.library=
b;this._depthProgStatic=[];this._depthProgSkin=[];this._depthProgStaticOp=[];this._depthProgSkinOp=[];this._depthProgStaticPoint=[];this._depthProgSkinPoint=[];this._depthProgStaticOpPoint=[];this._depthProgSkinOpPoint=[];for(var c=0;c<pc.SHADOW_VSM32+1;c++)this._depthProgStaticOp[c]={},this._depthProgSkinOp[c]={},this._depthProgStaticOpPoint[c]={},this._depthProgSkinOpPoint[c]={};this._depthShaderStatic=b.getProgram("depth",{skin:!1});this._depthShaderSkin=b.getProgram("depth",{skin:!0});this._depthShaderStaticOp=
{};this._depthShaderSkinOp={};for(var c=["r","g","b","a"],e=0;4>e;e++)this._depthShaderStaticOp[c[e]]=b.getProgram("depth",{skin:!1,opacityMap:!0,opacityChannel:c[e]}),this._depthShaderSkinOp[c[e]]=b.getProgram("depth",{skin:!0,opacityMap:!0,opacityChannel:c[e]}),this._depthShaderStaticOp[c[e]]=b.getProgram("depth",{skin:!1,opacityMap:!0,opacityChannel:c[e]}),this._depthShaderSkinOp[c[e]]=b.getProgram("depth",{skin:!0,opacityMap:!0,opacityChannel:c[e]});a=a.scope;this.projId=a.resolve("matrix_projection");
this.viewId=a.resolve("matrix_view");this.viewId3=a.resolve("matrix_view3");this.viewInvId=a.resolve("matrix_viewInverse");this.viewProjId=a.resolve("matrix_viewProjection");this.viewPosId=a.resolve("view_position");this.nearClipId=a.resolve("camera_near");this.farClipId=a.resolve("camera_far");this.lightRadiusId=a.resolve("light_radius");this.fogColorId=a.resolve("fog_color");this.fogStartId=a.resolve("fog_start");this.fogEndId=a.resolve("fog_end");this.fogDensityId=a.resolve("fog_density");this.modelMatrixId=
a.resolve("matrix_model");this.normalMatrixId=a.resolve("matrix_normal");this.poseMatrixId=a.resolve("matrix_pose[0]");this.boneTextureId=a.resolve("texture_poseMap");this.boneTextureSizeId=a.resolve("texture_poseMapSize");this.skinPosOffsetId=a.resolve("skinPosOffset");this.alphaTestId=a.resolve("alpha_ref");this.opacityMapId=a.resolve("texture_opacityMap");this.depthMapId=a.resolve("uDepthMap");this.screenSizeId=a.resolve("uScreenSize");this._screenSize=new pc.Vec4;this.sourceId=a.resolve("source");
this.pixelOffsetId=a.resolve("pixelOffset");this.weightId=a.resolve("weight[0]");a=pc.shaderChunks;this.blurVsmShaderCode=[a.blurVSMPS,"#define GAUSS\n"+a.blurVSMPS];this.blurPackedVsmShaderCode=["#define PACKED\n"+this.blurVsmShaderCode[0],"#define PACKED\n"+this.blurVsmShaderCode[1]];this.blurVsmShader=[{},{}];this.blurPackedVsmShader=[{},{}];this.blurVsmWeights={};this.fogColor=new Float32Array(3);this.ambientColor=new Float32Array(3)}for(var g=(new pc.Mat4).mul2((new pc.Mat4).setTranslate(.5,
...
"_direction").setValue(d._direction.normalize().data);if(d.getCastShadows()){g=this.device.extDepthTexture?d._shadowCamera._renderTarget._depthTexture:d._shadowCamera._renderTarget.colorBuffer;var m=d._shadowType>pc.SHADOW_DEPTH?-2E-4:d._shadowBias/d._shadowCamera.getFarClip()*100,n=d._shadowType>pc.SHADOW_DEPTH?.0025/(d._shadowCamera.getFarClip()/7):d._normalOffsetBias;k.resolve(h+"_shadowMap").setValue(g);k.resolve(h+"_shadowMatrix").setValue(d._shadowMatrix.data);k.resolve(h+"_shadowParams").setValue([d._shadowResolution,
...
if(A===pc.PIXELFORMAT_RGB16F||A===pc.PIXELFORMAT_RGB32F)r=!0,a._gammaCorrection=pc.GAMMA_NONE,a._toneMapping=pc.TONEMAP_LINEAR,a.exposure=1}var J,I,za,K,C=a._lights,Z=a.drawCalls,W=Z.length,Ia=a.shadowCasters,T,F,ca,N,Ja=null,ma,fa;a._globalLights.length=0;a._localLights[0].length=0;for(J=a._localLights[1].length=0;J<C.length;J++)K=C[J],K.getEnabled()&&(K.getType()===pc.LIGHTTYPE_DIRECTIONAL?a._globalLights.push(K):a._localLights[K.getType()===pc.LIGHTTYPE_POINT?0:1].push(K));var na=[],Aa,U,ja,Wa;
...
La.minFilter=pc.FILTER_NEAREST;La.magFilter=pc.FILTER_NEAREST;La.addressU=pc.ADDRESS_CLAMP_TO_EDGE;La.addressV=pc.ADDRESS_CLAMP_TO_EDGE;b._depthTarget=new pc.RenderTarget(h,La,{depth:!0})}var vb=b.getRenderTarget();b.setRenderTarget(b._depthTarget);this.setCamera(b);var wb=h.getBlending();h.setBlending(!1);for(J=0;J<W;J++)F=Z[J],!F.command&&F.drawToDepth&&F.material.blendType===pc.BLEND_NONE&&(ca=F.mesh,this.modelMatrixId.setValue(F.node.worldTransform.data),N=F.material,N.opacityMap&&(this.opacityMapId.setValue(N.opacityMap),
this.alphaTestId.setValue(N.alphaTest),N.opacityMapChannel&&(Y=N.opacityMapChannel)),F.skinInstance?(this._skinDrawCalls++,this.skinPosOffsetId.setValue(F.skinInstance.rootNode.getPosition().data),h.supportsBoneTextures?(fa=F.skinInstance.boneTexture,this.boneTextureId.setValue(fa),this.boneTextureSizeId.setValue([fa.width,fa.height])):this.poseMatrixId.setValue(F.skinInstance.matrixPalette),h.setShader(N.opacityMap?this._depthShaderSkinOp[Y]:this._depthShaderSkin)):h.setShader(N.opacityMap?this._depthShaderStaticOp[Y]:
this._depthShaderStatic),ma=F.renderStyle,h.setVertexBuffer(ca.vertexBuffer,0),h.setIndexBuffer(ca.indexBuffer[ma]),h.draw(ca.primitive[ma]),this._depthDrawCalls++),b.setRenderTarget(vb);h.setBlending(wb)}else b._depthTarget&&(b._depthTarget.destroy(),b._depthTarget=null);var ua,va,Da,Ea,Fa,Ga,Xa,Ya,aa;for(J=0;J<C.length;J++){K=C[J];var ra=K.getType();if(K.getCastShadows()&&K.getEnabled()&&K.shadowUpdateMode!==pc.SHADOWUPDATE_NONE){K.shadowUpdateMode===pc.SHADOWUPDATE_THISFRAME&&(K.shadowUpdateMode=
pc.SHADOWUPDATE_NONE);var O=this.getShadowCamera(h,K),Za=1,oa,sa;O._node.setPosition(K._node.getPosition());O._node.setRotation(K._node.getRotation());O._node.rotateLocal(-90,0,0);if(ra===pc.LIGHTTYPE_DIRECTIONAL){var Ma=b,Na=K.getShadowDistance()||b.getFarClip(),V=B,Oa=Ma.getNearClip(),jb=Ma.getFov()*Math.PI/180,kb=Ma.getAspectRatio(),lb=Ma.getProjection(),pa=void 0,ha=void 0,ha=lb===pc.PROJECTION_PERSPECTIVE?Math.tan(jb/2)*Oa:Ma._orthoHeight,pa=ha*kb;V[0].x=pa;V[0].y=-ha;V[0].z=-Oa;V[1].x=pa;V[1].y=
...
0;8>I;I++){var ia=B[I];ia.x<ua&&(ua=ia.x);ia.x>Ea&&(Ea=ia.x);ia.y<va&&(va=ia.y);ia.y>Fa&&(Fa=ia.y);ia.z<Da&&(Da=ia.z);ia.z>Ga&&(Ga=ia.z)}var Ta=sa/K.getShadowResolution(),$a=.5*(sa-(Ea-ua));ua=Math.floor((ua-$a)/Ta)*Ta;$a=.5*(sa-(Fa-va));va=Math.floor((va-$a)/Ta)*Ta;Ea=ua+sa;Fa=va+sa;Xa=.5*(Ea+ua);Ya=.5*(Fa+va);O._node.translateLocal(Xa,Ya,1E5);O.setProjection(pc.PROJECTION_ORTHOGRAPHIC);O.setNearClip(0);O.setFarClip(2E5);O.setAspectRatio(1);O.setOrthoHeight(.5*sa)}else if(ra===pc.LIGHTTYPE_SPOT){if(b.frustumCulling&&
(K._node.getWorldTransform(),K.getBoundingSphere(w),!b._frustum.containsSphere(w)))continue;O.setProjection(pc.PROJECTION_PERSPECTIVE);O.setNearClip(K.getAttenuationEnd()/1E3);O.setFarClip(K.getAttenuationEnd());O.setAspectRatio(1);O.setFov(2*K.getOuterConeAngle());this.viewPosId.setValue(O._node.getPosition().data);this.lightRadiusId.setValue(K.getAttenuationEnd())}else if(ra===pc.LIGHTTYPE_POINT){if(b.frustumCulling&&(K._node.getWorldTransform(),K.getBoundingSphere(w),!b._frustum.containsSphere(w)))continue;
O.setProjection(pc.PROJECTION_PERSPECTIVE);O.setNearClip(K.getAttenuationEnd()/1E3);O.setFarClip(K.getAttenuationEnd());O.setAspectRatio(1);O.setFov(90);Za=6;this.viewPosId.setValue(O._node.getPosition().data);this.lightRadiusId.setValue(K.getAttenuationEnd())}this._shadowMapUpdates+=Za;Y="r";for(oa=0;oa<Za;oa++){ra===pc.LIGHTTYPE_POINT&&(0===oa?O._node.setEulerAngles(0,90,180):1===oa?O._node.setEulerAngles(0,-90,180):2===oa?O._node.setEulerAngles(90,0,0):3===oa?O._node.setEulerAngles(-90,0,0):4===
oa?O._node.setEulerAngles(0,180,180):5===oa&&O._node.setEulerAngles(0,0,180),O._node.setPosition(K._node.getPosition()),O.setRenderTarget(K._shadowCubeMap[oa]));this.setCamera(O,ra!==pc.LIGHTTYPE_POINT);na=[];I=0;for(za=Ia.length;I<za;I++)F=Ia[I],Aa=!0,F.cull&&(Aa=this._isVisible(O,F)),Aa&&na.push(F);if(ra===pc.LIGHTTYPE_DIRECTIONAL){ja=!0;for(I=0;I<na.length;I++)F=na[I],Wa=F.aabb,ja?(z.copy(Wa),ja=!1):z.add(Wa);var xb=n,ab=z.getMin(),bb=z.getMax();E[0].x=E[1].x=E[2].x=E[3].x=ab.x;E[1].y=E[3].y=E[7].y=
E[5].y=ab.y;E[2].z=E[3].z=E[6].z=E[7].z=ab.z;E[4].x=E[5].x=E[6].x=E[7].x=bb.x;E[0].y=E[2].y=E[4].y=E[6].y=bb.y;E[0].z=E[1].z=E[4].z=E[5].z=bb.z;for(var cb=9999999999,db=-9999999999,Pa=void 0,Qa=0;8>Qa;++Qa)xb.transformPoint(E[Qa],E[Qa]),Pa=E[Qa].z,Pa<cb&&(cb=Pa),Pa>db&&(db=Pa);c=cb;Ga=f=db;c>Da&&(Da=c);O._node.setPosition(K._node.getPosition());O._node.translateLocal(Xa,Ya,Ga+.01);O.setFarClip(Ga-Da);this.setCamera(O,!0)}ra!==pc.LIGHTTYPE_POINT&&(n.setTRS(O._node.getPosition(),O._node.getRotation(),
pc.Vec3.ONE).invert(),k.mul2(O.getProjectionMatrix(),n),K._shadowMatrix.mul2(g,k));h.setBlending(!1);h.setColorWrite(!0,!0,!0,!0);h.setDepthWrite(!0);h.setDepthTest(!0);h.extDepthTexture&&h.setColorWrite(!1,!1,!1,!1);R=K._shadowType;I=0;for(za=na.length;I<za;I++)F=na[I],ca=F.mesh,N=F.material,h.setCullMode(N.cull),this.modelMatrixId.setValue(F.node.worldTransform.data),N.opacityMap&&(this.opacityMapId.setValue(N.opacityMap),this.alphaTestId.setValue(N.alphaTest),N.opacityMapChannel&&(Y=N.opacityMapChannel)),
...
0),h.setIndexBuffer(ca.indexBuffer[ma]),h.draw(ca.primitive[ma]),this._shadowDrawCalls++}if(K._shadowType>pc.SHADOW_DEPTH){var wa=K._vsmBlurSize;if(1<wa){var mb=O.getRenderTarget(),nb=e(h,K._shadowResolution,K._shadowType,1),Ra=K._vsmBlurMode,Ua=(K._shadowType===pc.SHADOW_VSM8?this.blurPackedVsmShader:this.blurVsmShader)[Ra][wa];if(!Ua){var yb=this.blurVsmWeights,zb=wa,Ba=wa;25<Ba&&(Ba=25);for(var ob=(Ba-1)/6,la=void 0,Ha=void 0,eb=void 0,pb=void 0,pb=.5*(Ba-1),Ha=Array(Ba),la=eb=0;la<Ba;++la){var qb=
la-pb;Ha[la]=Math.exp(-(qb*qb)/(2*ob*ob));eb+=Ha[la]}for(la=0;la<Ba;++la)Ha[la]/=eb;yb[zb]=Ha;var rb=pc.shaderChunks;(K._shadowType===pc.SHADOW_VSM8?this.blurPackedVsmShader:this.blurVsmShader)[Ra][wa]=Ua=rb.createShaderFromCode(this.device,rb.fullscreenQuadVS,"#define SAMPLES "+wa+"\n"+(K._shadowType===pc.SHADOW_VSM8?this.blurPackedVsmShaderCode:this.blurVsmShaderCode)[Ra],"blurVsm"+Ra+""+wa+""+(K._shadowType===pc.SHADOW_VSM8))}l.z=K._shadowResolution-2;l.w=l.z;this.sourceId.setValue(mb.colorBuffer);
m.x=1/K._shadowResolution;m.y=0;this.pixelOffsetId.setValue(m.data);Ra===pc.BLUR_GAUSSIAN&&this.weightId.setValue(this.blurVsmWeights[wa]);pc.drawQuadWithShader(h,nb,Ua,null,l);this.sourceId.setValue(nb.colorBuffer);m.y=m.x;m.x=0;this.pixelOffsetId.setValue(m.data);pc.drawQuadWithShader(h,mb,Ua,null,l)}}}}this.setCamera(b);this.dispatchGlobalLights(a);if(a.fog!==pc.FOG_NONE){this.fogColor[0]=a.fogColor.r;this.fogColor[1]=a.fogColor.g;this.fogColor[2]=a.fogColor.b;if(a.gammaCorrection)for(J=0;3>J;J++)this.fogColor[J]=
Math.pow(this.fogColor[J],2.2);this.fogColorId.setValue(this.fogColor);a.fog===pc.FOG_LINEAR?(this.fogStartId.setValue(a.fogStart),this.fogEndId.setValue(a.fogEnd)):this.fogDensityId.setValue(a.fogDensity)}pc._instanceVertexFormat||(pc._instanceVertexFormat=new pc.VertexFormat(h,[{semantic:pc.SEMANTIC_TEXCOORD2,components:4,type:pc.ELEMENTTYPE_FLOAT32},{semantic:pc.SEMANTIC_TEXCOORD3,components:4,type:pc.ELEMENTTYPE_FLOAT32},{semantic:pc.SEMANTIC_TEXCOORD4,components:4,type:pc.ELEMENTTYPE_FLOAT32},
{semantic:pc.SEMANTIC_TEXCOORD5,components:4,type:pc.ELEMENTTYPE_FLOAT32}]));h.enableAutoInstancing&&!pc._autoInstanceBuffer&&(pc._autoInstanceBuffer=new pc.VertexBuffer(h,pc._instanceVertexFormat,h.autoInstancingMaxObjects,pc.BUFFER_DYNAMIC),pc._autoInstanceBufferData=new Float32Array(pc._autoInstanceBuffer.lock()));var ta,Va,qa,sb,Sa,tb,xa,ea,Ca;this._screenSize.x=h.width;this._screenSize.y=h.height;this._screenSize.z=1/h.width;this._screenSize.w=1/h.height;this.screenSizeId.setValue(this._screenSize.data);
b._depthTarget&&this.depthMapId.setValue(b._depthTarget.colorBuffer);for(J=0;J<W;J++)if(T=Z[J],T.command)T.command();else{F=T;ca=F.mesh;N=F.material;qa=F._shaderDefs;Sa=F.mask;if(h.enableAutoInstancing&&J!==W-1&&h.extInstancing&&(ta=J+1,Z[ta].mesh===ca&&Z[ta].material===N)){for(I=0;16>I;I++)pc._autoInstanceBufferData[I]=T.node.worldTransform.data[I];for(Va=1;ta!==W&&Z[ta].mesh===ca&&Z[ta].material===N;){for(I=0;16>I;I++)pc._autoInstanceBufferData[16*Va+I]=Z[ta].node.worldTransform.data[I];Va++;ta++}F.instancingData=
{};F.instancingData.count=Va;F.instancingData._buffer=pc._autoInstanceBuffer;F.instancingData._buffer.unlock();J=ta-1}if(F.instancingData&&h.extInstancing)qa|=pc.SHADERDEF_INSTANCING,F.instancingData._buffer||(F.instancingData._buffer=new pc.VertexBuffer(h,pc._instanceVertexFormat,T.instancingData.count,T.instancingData.usage,F.instancingData.buffer));else{qa&=~pc.SHADERDEF_INSTANCING;var ub=F.node.worldTransform,fb=F.normalMatrix;ub.invertTo3x3(fb);fb.transpose();this.modelMatrixId.setValue(ub.data);
this.normalMatrixId.setValue(fb.data)}F.skinInstance&&(this._skinDrawCalls++,this.skinPosOffsetId.setValue(F.skinInstance.rootNode.getPosition().data),h.supportsBoneTextures?(fa=F.skinInstance.boneTexture,this.boneTextureId.setValue(fa),this.boneTextureSizeId.setValue([fa.width,fa.height])):this.poseMatrixId.setValue(F.skinInstance.matrixPalette));N&&N===Ja&&qa!==sb&&(Ja=null);if(N!==Ja){this._materialSwitches++;F._shader&&F._shaderDefs===qa||(F._shader=N.variants[qa],F._shader||(N.updateShader(h,
a,qa),F._shader=N.variants[qa]=N.shader),F._shaderDefs=qa);h.setShader(F._shader);Ca=N.parameters;for(xa in Ca)ea=Ca[xa],ea.scopeId||(ea.scopeId=h.scope.resolve(xa)),ea.scopeId.setValue(ea.data);if(!Ja||Sa!==tb){var Ab=this.dispatchDirectLights(a,Sa);this.dispatchLocalLights(a,Sa,Ab)}this.alphaTestId.setValue(N.alphaTest);h.setBlending(N.blend);h.setBlendFunction(N.blendSrc,N.blendDst);h.setBlendEquation(N.blendEquation);h.setColorWrite(N.redWrite,N.greenWrite,N.blueWrite,N.alphaWrite);h.setCullMode(N.cull);
h.setDepthWrite(N.depthWrite);h.setDepthTest(N.depthTest)}Ca=F.parameters;for(xa in Ca)ea=Ca[xa],ea.scopeId||(ea.scopeId=h.scope.resolve(xa)),ea.scopeId.setValue(ea.data);h.setVertexBuffer(ca.vertexBuffer,0);ma=F.renderStyle;h.setIndexBuffer(ca.indexBuffer[ma]);F.instancingData?(this._instancedDrawCalls++,this._removedByInstancing+=T.instancingData.count,h.setVertexBuffer(F.instancingData._buffer,1),h.draw(ca.primitive[ma],T.instancingData.count),F.instancingData._buffer===pc._autoInstanceBuffer&&
(F.instancingData=null)):h.draw(ca.primitive[ma]);this._forwardDrawCalls++;if(J<W-1&&Z[J+1].material===N)for(xa in Ca)(ea=N.parameters[xa])&&ea.scopeId.setValue(ea.data);Ja=N;sb=qa;tb=Sa}h.setColorWrite(!0,!0,!0,!0);0<a.immediateDrawCalls.length&&(a.immediateDrawCalls=[]);r&&(a._gammaCorrection=t,a._toneMapping=x,a.exposure=u);this._camerasRendered++}});return{ForwardRenderer:h}}());pc.extend(pc,function(){var d=function(){this.name="Untitled";this._labels={};this.localPosition=new pc.Vec3(0,0,0);this.localRotation=new pc.Quat(0,0,0,1);this.localScale=new pc.Vec3(1,1,1);this.localEulerAngles=new pc.Vec3(0,0,0);this.position=new pc.Vec3(0,0,0);this.rotation=new pc.Quat(0,0,0,1);this.eulerAngles=new pc.Vec3(0,0,0);this.localTransform=new pc.Mat4;this.dirtyLocal=!1;this._dirtyScale=!0;this.worldTransform=new pc.Mat4;this.dirtyWorld=!1;this._right=new pc.Vec3;this._up=new pc.Vec3;
...
1<=a?Math.pow(this._finalColor.data[b]/a,2.2)*a:Math.pow(this._finalColor.data[b],2.2)},setOuterConeAngle:function(a){this._outerConeAngle=a;this._outerConeAngleCos=Math.cos(a*Math.PI/180)},setShadowBias:function(a){this._shadowBias=a},setNormalOffsetBias:function(a){if(!this._normalOffsetBias&&a||this._normalOffsetBias&&!a)this._scene.updateShaders=!0;this._normalOffsetBias=a},setShadowDistance:function(a){this._shadowDistance=a},setShadowResolution:function(a){var b=pc.Application.getApplication().graphicsDevice;
this._shadowResolution=a=this._type===pc.LIGHTTYPE_POINT?Math.min(a,b.maxCubeMapSize):Math.min(a,b.maxTextureSize)},setType:function(a){this._type=a;this._destroyShadowMap()},_destroyShadowMap:function(){if(this._shadowCamera){var a=this._shadowCamera._renderTarget,b;if(a)if(a.length)for(b=0;b<a.length;b++)a[b].colorBuffer&&a[b].colorBuffer.destroy(),a[b].destroy();else a.colorBuffer&&a.colorBuffer.destroy(),a.destroy();this._shadowCubeMap=this._shadowCamera=this._shadowCamera._renderTarget=null}},
...
g=0!==(c&pc.SHADERDEF_UV1),d=0!==(c&pc.SHADERDEF_VCOLOR));for(var L in pc._matTex2D)if("opacity"!==L||this.blendType!==pc.BLEND_NONE||0!==this.alphaTest)h=L+"Map",l=h+"VertexColor","height"!==L&&this[l]?d&&(h+="Channel",b[l]=this[l],b[h]=this[h],b.vertexColors=!0):this[h]&&(l=h+"Uv",k=!0,0!==this[l]||f||(k=!1),1!==this[l]||g||(k=!1),k&&(b[h]=!!this[h],k=h+"Transform",h+="Channel",b[k]=this._getMapTransformID(this[k],this[l]),b[h]=this[h],b[l]=this[l]));b.aoMapUv=b.aoMapUv||this.aoUvSet;this._mapXForms=
null;L=[];f=c?c>>8:1;this._collectLights(pc.LIGHTTYPE_DIRECTIONAL,e,L,f);this._collectLights(pc.LIGHTTYPE_POINT,e,L,f);this._collectLights(pc.LIGHTTYPE_SPOT,e,L,f);b.lights=L;this.shader=a.getProgramLibrary().getProgram("standard",b);c||(this.clearVariants(),this.variants[0]=this.shader);this.dirtyShader=!1}});(function(c){c.dirtyShader=!0;c.dirtyColor=!0;c._scene=null;m(c,"ambient",new pc.Color(.7,.7,.7));m(c,"diffuse",new pc.Color(1,1,1));m(c,"specular",new pc.Color(0,0,0));m(c,"emissive",new pc.Color(0,
...
v)throw Error("partitionSkin: All meshes that share a skin should also share the same vertex buffer");var z=[],u=[];l=[];var A=0;for(m=0;m<w.length;m++){r=w[m];for(var B=r.indices,C=r.base;C<r.base+r.count;){n=B[C++];u[0]=x(n);l[0]=n;n=B[C++];u[1]=x(n);l[1]=n;n=B[C++];u[2]=x(n);l[2]=n;for(var E=!1,L=A;L<z.length;L++)if(n=z[L],n.addPrimitive(u,l,v,h)){E=!0;break}E||(n=new a,n.originalMesh=r,n.addPrimitive(u,l,v,h),z.push(n))}A=z.length}r=[];w=[];for(m=0;m<z.length;m++)if(n=z[m],n.vertices.length&&
...
this.node.getPosition();this.emitterShape===pc.EMITTERSHAPE_BOX&&(null===this.node?M.setTRS(pc.Vec3.ZERO,pc.Quat.IDENTITY,this.spawnBounds):M.setTRS(pc.Vec3.ZERO,this.node.getRotation(),X.copy(this.spawnBounds).mul(this.node.getLocalScale())));for(a=0;a<this.numParticles;a++)this.calcSpawnPosition(c,a),this.useCpu&&(this.particleTex[4*a+3+8*this.numParticlesPot]=1);this.particleTexStart=new Float32Array(this.numParticlesPot*q*4);for(a=0;a<this.particleTexStart.length;a++)this.particleTexStart[a]=
...
pc.calculateTangents=function(d,a,b,c){var e=c.length/3,f=d.length/3,h,g,m,l,n,k,q,r,p,t,x,y,w,v,z=new pc.Vec3,u=new pc.Vec3,A=new pc.Vec3,B=new pc.Vec3,C=new pc.Vec3,E=new pc.Vec2,L=new pc.Vec2,P=new pc.Vec2,M,H=new Float32Array(3*f),D=new Float32Array(3*f),X=[];for(M=0;M<e;M++)h=c[3*M],g=c[3*M+1],m=c[3*M+2],A.set(d[3*h],d[3*h+1],d[3*h+2]),B.set(d[3*g],d[3*g+1],d[3*g+2]),C.set(d[3*m],d[3*m+1],d[3*m+2]),E.set(b[2*h],b[2*h+1]),L.set(b[2*g],b[2*g+1]),P.set(b[2*m],b[2*m+1]),l=B.x-A.x,n=C.x-A.x,k=B.y-
A.y,q=C.y-A.y,r=B.z-A.z,p=C.z-A.z,t=L.x-E.x,x=P.x-E.x,y=L.y-E.y,w=P.y-E.y,v=1/(t*w-x*y),z.set((w*l-y*n)*v,(w*k-y*q)*v,(w*r-y*p)*v),u.set((t*n-x*l)*v,(t*q-x*k)*v,(t*p-x*r)*v),H[3*h+0]+=z.x,H[3*h+1]+=z.y,H[3*h+2]+=z.z,H[3*g+0]+=z.x,H[3*g+1]+=z.y,H[3*g+2]+=z.z,H[3*m+0]+=z.x,H[3*m+1]+=z.y,H[3*m+2]+=z.z,D[3*h+0]+=u.x,D[3*h+1]+=u.y,D[3*h+2]+=u.z,D[3*g+0]+=u.x,D[3*g+1]+=u.y,D[3*g+2]+=u.z,D[3*m+0]+=u.x,D[3*m+1]+=u.y,D[3*m+2]+=u.z;y=new pc.Vec3;w=new pc.Vec3;d=new pc.Vec3;b=new pc.Vec3;for(M=0;M<f;M++)d.set(a[3*
M],a[3*M+1],a[3*M+2]),y.set(H[3*M],H[3*M+1],H[3*M+2]),w.set(D[3*M],D[3*M+1],D[3*M+2]),c=d.dot(y),b.copy(d).scale(c),b.sub2(y,b).normalize(),X[4*M]=b.x,X[4*M+1]=b.y,X[4*M+2]=b.z,b.cross(d,y),X[4*M+3]=0>b.dot(w)?-1:1;return X};
...
a.file.url,a);a.fire("load",a)};if(a.file&&"cubemap"===a.type){var c=!1,h=a.file.url,g=-1!==h.indexOf("?")?"&":"?",h=h+(g+a.file.hash);this._loader.load(h,"texture",function(c,d){c?(b.fire("error",c,a),b.fire("error:"+a.id,c,a),a.fire("error",c,a)):(b._loader.patch({resource:d,type:"texture",data:a.data},b),a._dds=d,f())})}a.file?c&&(this.fire("load:start",a),this.fire("load:"+a.id+":start",a),d()):f()}}},loadFromUrl:function(a,b,c){var d=pc.path.getBasename(a),f={url:a},h={};a=this.getByUrl(a);a||
(a=new pc.Asset(d,b,f,h),this.add(a));"model"===b?this._loadModel(a,c):(a.once("load",function(a){c(null,a)}),a.once("error",function(a){c(a)}),this.load(a))},_loadModel:function(a,b){var c=this,d=a.getFileUrl(),f=pc.path.getDirectory(d),d=pc.path.getBasename(d);d.replace(".json","");var d=pc.path.join(f,d.replace(".json",".mapping.json")),h=function(a){a.once("load",function(a){b(null,a)});a.once("error",function(a){b(a)});c.load(a)};this._loader.load(d,"json",function(b,d){b?(a.data={mapping:[]},
h(a)):c._loadMaterials(f,d,function(b,c){a.data=d;h(a)})})},_loadMaterials:function(a,b,c){var d=this,f,h=b.mapping.length,g=[],m=function(a,b){d._loadTextures(b,function(a,d){c(null,b)})};0===h&&c(null,g);var l=function(a,b){g.push(b);h--;0===h&&m(null,g)};for(f=0;f<b.mapping.length;f++){var n=b.mapping[f].path;n?d.loadFromUrl(pc.path.join(a,n),"material",l):h--}},_loadTextures:function(a,b){var c,d,f={},h=[],g=[],m=0;for(c=0;c<a.length;c++)if(a[c].data.parameters){var l=a[c].data.parameters;for(d=
0;d<l.length;d++)if("texture"===l[d].type){var n=pc.path.getDirectory(a[c].getFileUrl()),n=pc.path.join(n,l[d].data);f[n]||(f[n]=!0,h.push(n),m++)}}else console.warn("Update material asset loader to support new material format");if(m)for(d=function(a,c){g.push(c);m--;a&&console.error(a);0===m&&b(null,g)},c=0;c<h.length;c++)this.loadFromUrl(h[c],"texture",d);else b(null,g)},findAll:function(a,b){var c=this,d=this._names[a];return d?(d=d.map(function(a){return c._assets[a]}),b?d.filter(function(a){return a.type===
...
function(a,b,d,h,g,m,l,n,k,q){function r(){}function p(a,b){if(!M(a))throw new TypeError("You must pass a resolver function as the first argument to the promise constructor");if(!(this instanceof p))throw new TypeError("Failed to construct 'Promise': Please use the 'new' operator, this object constructor cannot be called as a function.");this._id=H++;this._label=b;this._subscribers=[];E.instrument&&L("created",this);r!==a&&t(a,this)}function t(a,b){function c(a){z(b,a)}function d(a){A(b,a)}try{a(c,
d)}catch(e){d(e)}}function x(a,b,c,d){a=a._subscribers;var e=a.length;a[e]=b;a[e+da]=c;a[e+ba]=d}function y(a,b){var c,d,e=a._subscribers,f=a._detail;E.instrument&&L(b===da?"fulfilled":"rejected",a);for(var g=0;g<e.length;g+=3)c=e[g],d=e[g+b],w(b,c,d,f);a._subscribers=null}function w(a,b,c,d){var e,f,g,h,k=M(c);if(k)try{e=c(d),g=!0}catch(l){h=!0,f=l}else e=d,g=!0;v(b,e)||(k&&g?z(b,e):h?A(b,f):a===da?z(b,e):a===ba&&A(b,e))}function v(a,b){var c,d=null;try{if(a===b)throw new TypeError("A promises callback cannot return that same promise.");
if(P(b)&&(d=b.then,M(d)))return d.call(b,function(d){return c?!0:(c=!0,void(b!==d?z(a,d):u(a,d)))},function(b){return c?!0:(c=!0,void A(a,b))},"Settle: "+(a._label||" unknown promise")),!0}catch(e){return c?!0:(A(a,e),!0)}return!1}function z(a,b){a===b?u(a,b):v(a,b)||u(a,b)}function u(a,b){a._state===D&&(a._state=X,a._detail=b,E.async(B,a))}function A(a,b){a._state===D&&(a._state=X,a._detail=b,E.async(C,a))}function B(a){y(a,a._state=da)}function C(a){a._onerror&&a._onerror(a._detail);y(a,a._state=
ba)}var E=a.config,L=(b["default"],d["default"]),P=h.objectOrFunction,M=h.isFunction;a=h.now;g=g["default"];m=m["default"];l=l["default"];n=n["default"];k=k["default"];a="rsvp_"+a()+"-";var H=0;q["default"]=p;p.cast=g;p.all=m;p.race=l;p.resolve=n;p.reject=k;var D=void 0,X=0,da=1,ba=2;p.prototype={constructor:p,_id:void 0,_guidKey:a,_label:void 0,_state:void 0,_detail:void 0,_subscribers:void 0,_onerror:function(a){E.trigger("error",a)},then:function(a,b,c){var d=this;this._onerror=null;var e=new this.constructor(r,
c);if(this._state){var f=arguments;E.async(function(){w(d._state,e,f[d._state-1],d._detail)})}else x(this,e,a,b);return E.instrument&&L("chained",d,e),e},"catch":function(a,b){return this.then(null,a,b)},"finally":function(a,b){var c=this.constructor;return this.then(function(b){return c.resolve(a()).then(function(){return b})},function(b){return c.resolve(a()).then(function(){throw b;})},b)}}});a("rsvp/promise/all",["../utils","exports"],function(a,b){var d=a.isArray,h=a.isNonThenable;b["default"]=
...
C[k].shadowUpdateMode=C[k].getType()===pc.LIGHTTYPE_DIRECTIONAL?pc.SHADOWUPDATE_REALTIME:pc.SHADOWUPDATE_THISFRAME,v.push(C[k]))),B.push(C[k]._enabled),C[k].setEnabled(!1);k=pc.shaderChunks;var L=k.transformUv1VS,P=k.bakeLmEndPS;E=k.createShaderFromCode(r,k.fullscreenQuadVS,k.dilatePS,"lmDilate");var M=r.scope.resolve("source"),H=r.scope.resolve("pixelOffset"),D=p.drawCalls;for(k=0;k<D.length;k++)D[k].node&&D[k].node.getWorldTransform();var D=p.fog,X=p.ambientLight.r,da=p.ambientLight.g,ba=p.ambientLight.b,
ya=p.drawCalls;p.fog=pc.FOG_NONE;p.ambientLight.r=0;p.ambientLight.g=0;p.ambientLight.b=0;c||(c=new pc.Camera,c._node=new pc.GraphNode,c.setClearOptions({color:[0,0,0,0],depth:1,flags:pc.CLEARFLAG_COLOR}),c.frustumCulling=!1);var G,Q,J,I;for(G=0;G<x.length;G++)for(Q=x[G].model.model.meshInstances,k=0;k<Q.length;k++)Q[k]._shaderDefs&=~pc.SHADERDEF_LM;var za=[];for(G=0;G<x.length;G++)za[G]=x[G].model.castShadows,x[G].model.castShadows=x[G].model.data.castShadowsLightmap;var K=[],gb=[],Z=[],W;p.updateShadersFunc(r);
for(G=0;G<l.length;G++)for(Q=y[G],k=0;k<Q.length;k++)J=Q[k].material,K.push(J);m||(m=new pc.StandardMaterial,m.chunks.transformVS=L,m.chunks.endPS=P,m.ambient=new pc.Color(0,0,0),m.ambientTint=!0,m.chunks.outputAlphaPS="\n",m.chunks.outputAlphaOpaquePS="\n",m.chunks.outputAlphaPremulPS="\n",m.cull=pc.CULLFACE_NONE,m.forceUv1=!0,m.update(),m.updateShader(r,p));for(G=0;G<l.length;G++){Q=y[G];L=w[G];if(0<Q.length)for(f.copy(Q[0].aabb),k=0;k<Q.length;k++)Q[k].node.getWorldTransform(),f.add(Q[k].aabb);
k=new pc.BoundingBox;k.copy(f);gb.push(k);for(k=0;k<Q.length;k++)I=Q[k],I._shaderDefs&=~pc.SHADERDEF_LM,I.mask=4,I.deleteParameter("texture_lightMap"),I.material=m;P=new pc.RenderTarget(r,L,{depth:!1});Z.push(P)}for(q=0;q<v.length;q++)v[q].setEnabled(!1);for(k=0;k<v.length;k++){v[k].setEnabled(!0);v[k]._cacheShadowMap=!0;v[k].getType()!==pc.LIGHTTYPE_DIRECTIONAL&&(v[k]._node.getWorldTransform(),v[k].getBoundingSphere(g),h.center=g.center,h.halfExtents.x=g.radius,h.halfExtents.y=g.radius,h.halfExtents.z=
g.radius);v[k].getType()===pc.LIGHTTYPE_SPOT&&(G=v[k],W=this.renderer.getShadowCamera(r,G),W._node.setPosition(G._node.getPosition()),W._node.setRotation(G._node.getRotation()),W._node.rotateLocal(-90,0,0),W.setProjection(pc.PROJECTION_PERSPECTIVE),W.setNearClip(G.getAttenuationEnd()/1E3),W.setFarClip(G.getAttenuationEnd()),W.setAspectRatio(1),W.setFov(2*G.getOuterConeAngle()),this.renderer.updateCameraFrustum(W));for(G=0;G<l.length;G++){Q=y[G];L=w[G];f=gb[G];P=Z[G];I=z[L.width];J=I.colorBuffer;p.drawCalls=
...
Q[q])){Ia=!0;break}if(!Ia)continue}c.setRenderTarget(I);this.renderer.render(p,c);t.shadowMapTime+=this.renderer._shadowMapTime;t.forwardTime+=this.renderer._forwardTime;t.renderPasses++;w[G]=J;Z[G]=I;z[L.width]=P;for(q=0;q<Q.length;q++)I=Q[q],I.setParameter("texture_lightMap",J),I._shaderDefs|=pc.SHADERDEF_LM}v[k].setEnabled(!1);v[k]._cacheShadowMap=!1}for(G=t=0;G<l.length;G++){Q=y[G];L=w[G];P=Z[G];I=z[L.width];J=I.colorBuffer;W=new pc.Vec2(1/L.width,1/L.height);H.setValue(W.data);for(k=0;4>k;k++)M.setValue(L),
pc.drawQuadWithShader(r,I,E),M.setValue(J),pc.drawQuadWithShader(r,P,E);for(k=0;k<Q.length;k++)I=Q[k],I.mask=2,Q[k].material=K[t],Q[k].setParameter("texture_lightMap",L),t++;a.push(L);b.push(l[G]);P.destroy()}for(var T in z)z.hasOwnProperty(T)&&(z[T].colorBuffer.destroy(),z[T].destroy());for(G=0;G<x.length;G++)x[G].model.castShadows=za[G];for(k=0;k<v.length;k++)v[k].setMask(u[k]),v[k].shadowUpdateMode=A[k];for(k=0;k<C.length;k++)C[k].setEnabled(B[k]);p.drawCalls=ya;p.fog=D;p.ambientLight.r=X;p.ambientLight.g=
